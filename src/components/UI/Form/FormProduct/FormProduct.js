...
const form = (props) => {
  ...
  return (
    <form onSubmit={() => props.clicked(newProductData)}>
      ...
      <input id="url" required onChange={changeHandler} className={classes.input} type='url' placeholder='Write here...' /><br />
      <p className={classes.p}>SELECT CATEGORY</p>

      <select name="category" required onChange={changeHandler} id="category" className={classes.input} style={{ paddingLeft: '0.7rem' }}>
      ...
      <input id="name" required onChange={changeHandler} className={classes.input} type='text' placeholder='Write here...' /><br />
      <p className={classes.p}>PRICE</p>
      <input max={99999} id="price" required onChange={changeHandler} className={classes.input} type='number' placeholder='E.g. 4500' /><br />
